...
builder.Services.AddSingleton<IJsonConfigurationParser, JsonConfigurationParser>();
builder.Services.AddSingleton<JsonConfigurationImportService>();
...
builder.Services.AddHostedService(serviceProvider => serviceProvider.GetRequiredService<JsonConfigurationImportService>());
...
app.MapAdminJsonConfigurationImportEndpoints();
